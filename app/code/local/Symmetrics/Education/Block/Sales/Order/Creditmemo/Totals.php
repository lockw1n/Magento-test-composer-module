...
/**
 * Add new field block to credit memo on frontend.
 *
 * @category  Symmetrics
 * @package   Symmetrics_Education
 * @author    symmetrics - a CGI Group brand <info@symmetrics.de>
 ...
 * @link      http://www.symmetrics.de/
 */
class Symmetrics_Education_Block_Sales_Order_Creditmemo_Totals extends Mage_Sales_Block_Order_Creditmemo_Totals
{
    /**
